...
function App() {
  ...
  const fetchData = async () => {
    try {
      ...
      //console.log(result.matches[0].translation);
    } catch (error) {
      setApiError(error);
    } finally {
      setIsLoading(false);
